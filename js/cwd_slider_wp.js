...
function cwd_slider(div,caption,time,speed,auto,random,height,path,bg,heading2) {
	...
	jQuery(document).ready(function($) {
		...
		function buildNav() {
			...
			// Photo credits				
			$('.slider-container #photo-credits .photocredits-focus').hover(function(){
				console.log('hovered');
				clearInterval(slide_interval);
			});
			$('.slider-container #photo-credits .photocredits-focus').focus(function(){
				clearInterval(slide_interval);
			});
		...
		$('#photo-credits .photo-credit-text p span a').attr('tabindex', '1');
