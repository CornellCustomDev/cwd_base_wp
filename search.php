		...
		<div class="row">
			...
			<article id="main-article" class="primary">
				...
				<section>
					...
					<div class="cwd-component cwd-basic no-overlay<?php if( $archive_options['search_results']['appearance_search_results'] == 'grid' ) { echo ' tiles'; } ?>">

						<div class="cards<?php if( $archive_options['search_results']['appearance_search_results'] == 'grid' ) { echo ' flex-grid'; } ?>">
