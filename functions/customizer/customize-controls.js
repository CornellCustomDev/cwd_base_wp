...
(function() {
	wp.customize.bind( 'ready', function() {
		...
		// Only show Cornell logo position and mobile options when logo size is large.
		...
		// Academic unit visibility settings
		wp.customize( 'au_logo_switch_mobile', function( setting ) {
			wp.customize.control( 'au_logo_switch_red_mobile', function( control ) {
				var visibility = function() {
					if ( 'yes' === setting.get() ) {
						control.container.slideDown( 180 );
					} else {
