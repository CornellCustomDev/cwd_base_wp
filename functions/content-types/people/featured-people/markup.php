...
<div class="card"> 
	<div class="group-image">
		<a href="<?php the_permalink(); ?>">
			...
			<div class="overlay">
				<h3 class="designer"> <!-- .designer class provides fancier link behavior (and makes our WA team grind their teeth), omit the .designer class for standard link behavior -->
