 ...
 *
 * @wordpress-plugin
 * Plugin Name:       CD News Pull
 * Plugin URI:        https://github.com/CU-CommunityApps/cd-news-pull-wp-plugin.git
 ...
 * Text Domain:       cd-news-pull-wp-plugin
 ...
 */
define( 'CD_NEWS_PULL_WP_PLUGIN_VERSION', '1.0.0' );
...
register_activation_hook( __FILE__, 'activate_cd_news_pull_wp_plugin' );
register_deactivation_hook( __FILE__, 'deactivate_cd_news_pull_wp_plugin' );
 ...
 * @since    1.0.0
 */
function run_cd_news_pull_wp_plugin() {

	$plugin = new Cd_News_Pull_Wp_Plugin();
	$plugin->run();
}

run_cd_news_pull_wp_plugin();
