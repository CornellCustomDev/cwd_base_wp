	...
	class OG_Tags_Dashboard {
		...
		public function admin_enqueue_scripts( $hook ) {
		    ...
		    if ( $hook == 'settings_page_og-tags-options' ) {
		    	wp_enqueue_media();
		    	wp_enqueue_style( 'og-tags-style', get_stylesheet_directory_uri() . '/functions/plugins/og-tags/modules/dashboard/admin/css/og-tags.css' );
		        wp_enqueue_script( 'og-tags-script', get_stylesheet_directory_uri() . '/functions/plugins/og-tags/modules/dashboard/admin/js/og-tags.js', array( 'jquery' ), OG_TAGS_VERSION );
