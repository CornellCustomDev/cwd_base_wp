...
class Widget_Shortcode_Gutenberg {
	...
	function register_block() {
		wp_register_script(
			...
			get_stylesheet_directory() . '/functions/plugins/widget-shortcode/assets/block.js',
			array( 'wp-blocks', 'wp-i18n', 'wp-element', 'wp-components' ),
			filemtime( get_stylesheet_directory() . '/functions/plugins/widget-shortcode/assets/block.js' ),
			true
		);
