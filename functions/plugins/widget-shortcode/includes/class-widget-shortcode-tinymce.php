...
class Widget_Shortcode_TinyMCE {
	...
	function mce_external_plugins( $plugins ) {
		$plugins['widgetShortcode'] = get_stylesheet_directory() . '/functions/plugins/widget-shortcode/assets/tinymce.js';
	...
	function editor_parameters() {
		wp_localize_script( 'editor', 'widgetShortcodeTinyMCE', array(
			...
			'image' => get_stylesheet_directory() . '/functions/plugins/widget-shortcode/assets/widget-icon.png',
		) );
	}
}