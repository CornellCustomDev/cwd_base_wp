...
class WidgetContext {
	...
	function admin_scripts( $page ) {
		...
		wp_enqueue_style(
			'widget-context-css',
			'/wp-content/themes/cwd_base/functions/plugins/widget-context/assets/css/admin.css',
			null,
		...
		wp_enqueue_script(
			'widget-context-js',
			'/wp-content/themes/cwd_base/functions/plugins/widget-context/assets/js/widget-context.js',
			array( 'jquery' ),
			$this->plugin->asset_version()
		);
	}
