<?php
/**
 * Defines the class for the CDSN Widget.
 */

/**
 * The main widget class.
 */
if( ! class_exists('Section_Nav') ) {
	class Section_Nav extends WP_Widget {
		...
		function __construct() {
			$widget_ops = array(
				...
				'description' => __( 'Shows page ancestory (parents, grandparents, etc), siblings of ancestory and current page, and immediate children of the current page beneath the current top level page.', 'section-nav' ),
			);
			parent::__construct( 'section-nav', __( 'Section Navigation', 'cwd_base' ), $widget_ops );
		}
		...
		function widget( $args, $instance ) {
			...
			if ( is_front_page() || isset( $sub_front_page ) ) {
				...
				echo '<ul class="' . esc_attr( apply_filters( 'cdsn_list_class', 'cdsn-list' ) ) . '">';
			...
			$sect_title = apply_filters( 'section_nav_title', $sect_title );
