...
function activate_cd_events_pull_wp_plugin() {
	require_once 'includes/class-cd-events-pull-wp-plugin-activator.php';
...
function deactivate_cd_events_pull_wp_plugin() {
	require_once 'includes/class-cd-events-pull-wp-plugin-deactivator.php';
 ...
 */
require 'includes/class-cd-events-pull-wp-plugin.php';
