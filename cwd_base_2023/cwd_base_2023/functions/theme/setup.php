...
if ( ! function_exists ( 'cwd_base_setup' ) ) {
	...
	function cwd_base_setup() {
		...
		add_theme_support('custom-header', array(
			'width'         => 1280,
			'height'        => 320,
			'default-image' => get_template_directory_uri() . '/images/wp/headers/berries.png',
		...
		register_default_headers( array(
			'spring' => array(
				'url'           => get_template_directory_uri() . '/images/wp/headers/spring.png',
				'thumbnail_url' => get_template_directory_uri() . '/images/wp/headers/spring_thumb.png',
				'description'   => __( 'spring', 'Spring Header Image', 'cwd_base' )
			),
			'hilltop' => array(
				'url'           => get_template_directory_uri() . '/images/wp/headers/hilltop.png',
				'thumbnail_url' => get_template_directory_uri() . '/images/wp/headers/hilltop_thumb.png',
				'description'   => __( 'hilltop', 'Hilltop Header Image', 'cwd_base' )
			),
			'grassy_knoll' => array(
				'url'           => get_template_directory_uri() . '/images/wp/headers/grassy_knoll.png',
				'thumbnail_url' => get_template_directory_uri() . '/images/wp/headers/grassy_knoll_thumb.png',
				'description'   => __( 'grassy_knoll', 'Grassy Knoll Header Image', 'cwd_base' )
			),
			'campus' => array(
				'url'           => get_template_directory_uri() . '/images/wp/headers/campus.png',
				'thumbnail_url' => get_template_directory_uri() . '/images/wp/headers/campus_thumb.png',
				'description'   => __( 'campus', 'Campus Header Image', 'cwd_base' )
			),
			'clock' => array(
				'url'           => get_template_directory_uri() . '/images/wp/headers/clock.png',
				'thumbnail_url' => get_template_directory_uri() . '/images/wp/headers/clock_thumb.png',
				'description'   => __( 'clock', 'Clock Header Image', 'cwd_base' )
			),
			'library' => array(
				'url'           => get_template_directory_uri() . '/images/wp/headers/library.png',
				'thumbnail_url' => get_template_directory_uri() . '/images/wp/headers/library_thumb.png',
				'description'   => __( 'library', 'Library Header Image', 'cwd_base' )
			),
			'berries' => array(
				'url'           => get_template_directory_uri() . '/images/wp/headers/berries.png',
				'thumbnail_url' => get_template_directory_uri() . '/images/wp/headers/berries_thumb.png',
				'description'   => __( 'berries', 'Berries Header Image', 'cwd_base' )
			),
			'tower' => array(
				'url'           => get_template_directory_uri() . '/images/wp/headers/tower.png',
				'thumbnail_url' => get_template_directory_uri() . '/images/wp/headers/tower_thumb.png',
...
<img class="aligncenter wp-image-8234" src="/wp-content/themes/cwd_base_2023/images/wp/reading-settings.png" alt="" width="526" height="200" />
...
<h3>Post Types</h3>
Available post types are News, Events, People, Courses, Spotlights, and Photo Galleries. Add or remove post types on the <a href="' . $baseUrl . 'wp-admin/admin.php?page=theme-options">theme options</a> page.
...
<img class="aligncenter wp-image-8207 size-full" src="/wp-content/themes/cwd_base_2023/images/wp/replace-header-image.png" alt="The option to replace homepage header image with a slider." width="285" height="214" />
...
<div class="two-col margined"><img class="alignnone size-medium wp-image-6544" src="/wp-content/themes/cwd_base_2023/images/photos/plantations.jpg" alt="" width="300" height="300" /><img class="alignnone wp-image-6529 size-medium" src="/wp-content/themes/cwd_base_2023/images/photos/plantations.jpg" alt="" width="300" height="300" /></div>
<h3>Three Even Columns</h3>
<div class="three-col margined"><img class="alignnone size-medium wp-image-6497" src="/wp-content/themes/cwd_base_2023/images/photos/plantations.jpg" alt="" width="300" height="300" /><img class="alignnone size-medium wp-image-6499" src="/wp-content/themes/cwd_base_2023/images/photos/plantations.jpg" alt="" width="300" height="300" /><img class="alignnone size-medium wp-image-6495" src="/wp-content/themes/cwd_base_2023/images/photos/plantations.jpg" alt="" width="300" height="300" /></div>
<h3>Four Even Columns</h3>
<div class="four-col margined"><img class="alignnone wp-image-770 size-medium" src="/wp-content/themes/cwd_base_2023/images/photos/plantations.jpg" alt="Huatulco Coastline" width="300" height="300" /><img class="alignnone wp-image-766 size-medium" src="/wp-content/themes/cwd_base_2023/images/photos/plantations.jpg" alt="Big Sur" width="300" height="300" /><img class="alignnone size-medium wp-image-769" src="/wp-content/themes/cwd_base_2023/images/photos/plantations_square.jpg" alt="Brazil Beach" width="300" height="300" /><img class="alignnone wp-image-765 size-medium" src="/wp-content/themes/cwd_base_2023/images/photos/plantations.jpg" alt="Sea and Rocks" width="300" height="300" /><img class="alignnone wp-image-770 size-medium" src="/wp-content/themes/cwd_base_2023/images/photos/plantations_square.jpg" alt="Huatulco Coastline" width="300" height="300" /><img class="alignnone wp-image-766 size-medium" src="/wp-content/themes/cwd_base_2023/images/photos/plantations.jpg" alt="Big Sur" width="300" height="300" /><img class="alignnone size-medium wp-image-769" src="/wp-content/themes/cwd_base_2023/images/photos/plantations_square.jpg" alt="Brazil Beach" width="300" height="300" /><img class="alignnone wp-image-765 size-medium" src="/wp-content/themes/cwd_base_2023/images/photos/plantations.jpg" alt="Sea and Rocks" width="300" height="300" /></div>
...
<a class="back-to-toc" title="Back to Top" href="#main-article"><span class="sr-only">Back to Top</span></a>';
			...
			function cwd_base_pre_set_widget( $sidebar, $name, $args = array() ) {
				...
				unset( $sidebars[ 'sidebar-101' ] );
				unset( $sidebars[ 'sidebar-102' ] );
	...
	add_action( 'after_setup_theme', 'cwd_base_setup', 10 );
